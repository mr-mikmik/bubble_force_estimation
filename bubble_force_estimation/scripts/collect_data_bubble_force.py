...
if __name__ == '__main__':
    ...
    parser.add_argument('--grasp_area_size', type=float, default=(.25, .25), nargs=2, help='size of the y and z semiaxis of the inital grasp area')
    parser.add_argument('--move_length_limits', type=float, default=(.01, .05), nargs=2, help='(minimum_length, maximum_length) of the move')
    parser.add_argument('--grasp_width_limits', type=float, default=(20, 30), nargs=2, help='(minimum_width, maximum_width) of the grasp')
